...
<script>
	 ...
	 * 	@value normal 正常
	 * 	@value small 小尺寸
	 * @property {String} type = [default|indigo|primary|success｜warning｜error｜royal]  颜色类型
	 * 	@value default 灰色
	 * 	@value indigo 靛蓝
	 *  @value primary 蓝色
	 * 	@value success 绿色
...
<style lang="scss" scoped>
	...
	.uni-tag--indigo {
		color: $uni-text-color-inverse;
		background-color: $uni-color-indigo;
		border-width: 1rpx;
		border-style: solid;
		border-color: $uni-color-indigo;
	}

	.indigo-uni-tag--inverted {
